                ...
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">
                        ...
                        @if ($subscribeTransaction->is_paid)
                            <span
                                class="py-2 px-3 rounded-full bg-green-500 text-white text-sm font-bold w-fit">ACTIVE</span>
                        @else
                            <span
                                class="py-2 px-3 rounded-full bg-orange-500 text-white text-sm font-bold w-fit">PENDING</span>
                        @endif
                        <div>
