                    ...
                    <div class="item-card flex flex-row justify-between items-center">
                        ...
                        <div>
                            ...
                            @if ($transaction->is_paid)
                                <span
                                    class="py-2 px-3 rounded-full bg-green-500 text-white text-sm font-bold">ACTIVE</span>
                            @else
                                <span
                                    class="py-2 px-3 rounded-full bg-orange-500 text-white text-sm font-bold">PENDING</span>
                            @endif
                        </div>
